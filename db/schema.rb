...
ActiveRecord::Schema.define(version: 20170227171903) do
  ...
  create_table "viewable_groups_viewable_products", force: :cascade do |t|
  ...
  add_foreign_key "viewable_groups_viewable_products", "viewable_products"
  add_foreign_key "viewable_groups_viewable_products", "viewable_products_groups"
end
